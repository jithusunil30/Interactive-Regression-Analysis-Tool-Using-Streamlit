...
Built using **Streamlit + Python**, this application transforms raw data into meaningful insights through an interactive and user-friendly dashboard.
...
```
git clone https://github.com/YOUR-USERNAME/regression-analysis-streamlit.git
cd regression-analysis-streamlit
```
...
3. Choose model or enable auto-selection
4. Run analysis
5. View results, insights, and visualizations
